...
const MobileBottomNav = memo(() => {
    ...
    const handlePhoneCall = useCallback(() => {
        ...
        // Открываем звонок через Telegram WebApp (нативно на мобильных)
        ...
        // Haptic feedback для премиум-ощущения
    ...
    return (
        <div className="mobile-bottom-nav2025">
            {/* Каталог — активен (всегда или по логике) */}
